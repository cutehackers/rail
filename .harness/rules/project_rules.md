...
- This harness defaults to the Python Rail control-plane profile.
...
- Keep request composition, runtime orchestration, policy files, and user-facing skills separated by responsibility.
...
- Do not manually edit generated files such as `*.pb.go`, `*.gen.go`, or generated mocks unless the task explicitly requires regenerating them.
